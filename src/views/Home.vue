        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 3 del curso “Modelos Educativos Contemporáneos y Diversidad en el Aprendizaje”, explora la integración de herramientas digitales, metodologías activas y la Inteligencia Artificial (IA) en la educación. Se promueve una enseñanza innovadora, adaptativa y personalizada, destacando estrategias como gamificación, aprendizaje basado en proyectos y retos. También se analiza el papel de la IA para mejorar la experiencia educativa mediante análisis de datos, personalización del aprendizaje y automatización. Se reflexiona sobre los retos éticos, técnicos y pedagógicos, para una implementación efectiva, inclusiva y consciente, en diferentes contextos educativos.
